...
})({"1qGXv":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "4d63242ef5d27cac";
"use strict";
...
},{}],"5MLJ1":[function(require,module,exports) {
...
buttonChevron.addEventListener("click", ()=>{
    ...
    if (window.innerHeight / window.innerWidth < 2 && window.innerWidth < 650) informationMenu.classList.toggle("display");
    if (expanded) content.style.maxHeight = content.scrollHeight + "px";
    else content.style.maxHeight = null;
});

},{}]},["1qGXv","5MLJ1"], "5MLJ1", "parcelRequire834e")

//# sourceMappingURL=index.f5d27cac.js.map
