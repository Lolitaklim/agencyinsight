...
})({"5M4Ru":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "94a13002e11a1772";
"use strict";
...
},{}],"1jEzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateCasesDisplay", ()=>updateCasesDisplay);
...
const caseTemplate = (href, imageUrl, altImage, title, category, gridArea)=>`
    <a href="${href}" class="case" style="grid-area: ${gridArea}">
        <div class="container_img">
            <img src="${0, _globalVariables.SERVER_URL}/uploads/${imageUrl}" alt="${altImage}" />
        </div>
...
async function loadCases() {
    try {
        const response = await fetch(`${(0, _globalVariables.SERVER_URL)}/api/get_homepage_cases.php`);
...
},{"./../globalVariables":"djeUE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5M4Ru","1jEzs"], "1jEzs", "parcelRequire834e")

//# sourceMappingURL=index.e11a1772.js.map
