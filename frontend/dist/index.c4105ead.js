...
})({"fxw6g":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "d0a077cfc4105ead";
"use strict";
...
},{}],"bFzEd":[function(require,module,exports) {
...
const state = {};
const slideTemplate = (href, imageUrl, altImage, title, description, cssClass)=>`
<a href="${href}" class="${cssClass}">
<div class="container_img">
  <img src="${0, _globalVariablesJs.SERVER_URL}/uploads/${imageUrl}" alt="${altImage}"/>
</div>
...
function createSwiper(element) {
    new (0, _swiperDefault.default)(element, {
        modules: [
            (0, _modules.Autoplay),
...
function slidesHtml(cssClass) {
    return state.dataNews.map((item)=>slideTemplate(`#${item.href}`, item.image_url, item.alt_image, item.title, item.description, cssClass)).join("");
}
async function loadSwiperData(element, wrapper, script, cards) {
    try {
        const response = await fetch(`${(0, _globalVariablesJs.SERVER_URL)}/api/${script}`);
...
loadSwiperData("#newsSwiper", "newsSwiperWrapper", "get_homepage_news.php", "newsCards");
loadSwiperData("#mainNewsSwiper", "mainNewsSwiperWrapper", "get_swiper_hero.php");

},{"swiper":"iM6UL","swiper/modules":"9ktz6","../globalVariables.js":"djeUE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iM6UL":[function(require,module,exports) {
/**
 * Swiper 11.1.5
...
function setBreakpoint() {
    ...
    (0, _utilsMjs.v)(swiper.params, breakpointParams);
...
function moduleExtendParams(params, allModulesParams) {
    return function extendParams(obj) {
        ...
        if (typeof moduleParams !== "object" || moduleParams === null) {
            (0, _utilsMjs.v)(allModulesParams, obj);
            return;
        }
...
class Swiper {
    constructor(){
        ...
        if (!params) params = {};
        params = (0, _utilsMjs.v)({}, params);
        if (el && !params.el) params.el = el;
        const document1 = (0, _ssrWindowEsmMjs.g)();
        if (params.el && typeof params.el === "string" && document1.querySelectorAll(params.el).length > 1) {
            const swipers = [];
            document1.querySelectorAll(params.el).forEach((containerEl)=>{
                const newParams = (0, _utilsMjs.v)({}, params, {
                    el: containerEl
                });
        ...
        const swiperParams = (0, _utilsMjs.v)({}, defaults, allModulesParams);
        // Extend defaults with passed params
        swiper.params = (0, _utilsMjs.v)({}, swiperParams, extendedDefaults, params);
        swiper.originalParams = (0, _utilsMjs.v)({}, swiper.params);
        swiper.passedParams = (0, _utilsMjs.v)({}, params);
        // add event listeners
    ...
    destroy(deleteInstance, cleanStyles) {
        ...
        if (deleteInstance !== false) {
            ...
            (0, _utilsMjs.w)(swiper);
        }
        swiper.destroyed = true;
        return null;
    }
    static extendDefaults(newDefaults) {
        (0, _utilsMjs.v)(extendedDefaults, newDefaults);
    }
...
parcelHelpers.export(exports, "v", ()=>extend);
parcelHelpers.export(exports, "w", ()=>deleteProps);
var _ssrWindowEsmMjs = require("./ssr-window.esm.mjs");
...
},{"../shared/create-shadow.mjs":"bWkQq","../shared/effect-init.mjs":"88TTi","../shared/effect-target.mjs":"3jkAD","../shared/effect-virtual-transition-end.mjs":"dzFvU","../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"djeUE":[function(require,module,exports) {
// 'use strict'
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SERVER_URL", ()=>SERVER_URL);
const SERVER_URL = "http://localhost:8080" // const state = {}
;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fxw6g","bFzEd"], "bFzEd", "parcelRequire834e")

//# sourceMappingURL=index.c4105ead.js.map
